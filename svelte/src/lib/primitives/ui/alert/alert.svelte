	...
	export const alertVariants = tv({
		...
		variants: {
			variant: {
				...
				destructive: 'bg-error-500/10 text-error-700-300 border-error-500/40',
				warning: 'bg-warning-500/10 text-warning-700-300 border-warning-500/40',
				success: 'bg-success-500/10 text-success-700-300 border-success-500/40'
			}
		},
		defaultVariants: {
			variant: 'default'
